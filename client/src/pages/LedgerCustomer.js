...
import NewLedgerCustomerForm from "../components/NewLedgerCustomerForm";
...
function LinkComponent(params) {
  return <Link to={"/specificLedgerUser/" + params.value}>{params.value}</Link>;
}
let gridApi;
...
class LedgerCustomer extends Component {
  state = {
    addLedgerCustomerFormTrigger: false,
    customerList: [],
    columnDefs: [
      {
        field: "customerId",
  ...
  onCellValueChanged(params) {
    API.updateLedgerCustomer(params.data)
      .then((res) => {
        console.log(res);
      })
      .catch((err) => {
  ...
  showAddLedgerCustomerForm = () => {
    this.setState({
      addLedgerCustomerFormTrigger: true,
    });
  };
    ...
    return (
      <>
        ...
        <div className="sub-header">
          ...
          <button id="addCustomer" onClick={this.showAddLedgerCustomerForm}>
            Add Customer
          </button>
        ...
        <NewLedgerCustomerForm
          trigger={this.state.addLedgerCustomerFormTrigger}
          closeAddLedgerCustomerForm={this.closeAddLedgerCustomerForm}
        ></NewLedgerCustomerForm>
...
export default withRouter(LedgerCustomer);
